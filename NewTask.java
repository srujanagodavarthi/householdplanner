...
public class NewTask extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDbAdapter = new LoginDataBaseAdapter(this);
		mDbAdapter.open();
		...
		mRowId = (savedInstanceState == null) ? null :
            (Long) savedInstanceState.getSerializable(LoginDataBaseAdapter.KEY_ROW_ID);
		if (mRowId == null) {
			Bundle extras = getIntent().getExtras();
			mRowId = extras != null ? extras.getLong(LoginDataBaseAdapter.KEY_ROW_ID)
									: null;
		}
	...
	private void populateFields() {
		if (mRowId != null) {
            ...
            mTask.setText(c.getString(
                    c.getColumnIndexOrThrow(LoginDataBaseAdapter.KEY_TASK)));
            mDesc.setText(c.getString(
                    c.getColumnIndexOrThrow(LoginDataBaseAdapter.KEY_DESCRIPTION)));
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		saveState();
		outState.putSerializable(LoginDataBaseAdapter.KEY_ROW_ID, mRowId);
	}
